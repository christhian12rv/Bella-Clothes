$(window).on("load", function () {
    $(".sidebar-link.configuracoes").addClass("active").addClass("only");
    $(".sidebar-link.empresa").addClass("active");

    $("input#cep").mask("00000-000");
    $("input#cep").on("input", validaCEP);
    $("input#telefone").phoneBrazil();
    $("input#outro_telefone").phoneBrazil();
    $("input#nome, input#cidade, input#endereco, input#complemento, input#bairro").on("input", capitalizeValue);
})
